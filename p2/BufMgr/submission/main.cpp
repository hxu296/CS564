...
/**
 * Project entry point. Tests the implementation of the BufMgr class.
 *
 * @return 0 if process finished with no error, errorno otherwise.
 */
int main() 
{
...
/**
 * Set up the run time environment for testing BufMgr and call tests one by one.
 */
void testBufMgr()
{
...
/**
 * Basic test for BufMgr::allocPage and BufMgr::readPage.
 */
void test1()
{
...
/**
 * Stress test for BufMgr::allocPage and BufMgr::readPage.
 */
void test2()
{
...
/**
 * Test for the error handling of BufMgr::readPage. Reading a non existing page.
 */
void test3()
{
	try
...
/**
 * Test for the error handling of BufMgr::unPinPage. UnPin an already unpinned page.
 */
void test4()
{
...
/**
 * Test for the error handling of BufMgr::allocBuf. No frame left for allocation.
 */
void test5()
{
	for (i = 0; i < num; i++) {
...
/**
 * Test for the error handling of BufMgr::flushFile. Page pinned for file being flushed.
 */
void test6()
{
...
/**
 * Basic test for the BufMgr::disposePage.
 */
void test7()
{
    //allocating pages
